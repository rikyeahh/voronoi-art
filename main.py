...
def generate_voronoi(img_path):
    ...
    fig, ax = plt.subplots()
    for region in tqdm(vor.regions):
...
def main():
    ...
    parser.add_argument('--i', type=str, required=False,  default='jap.jpg',
                    help='Input file name on which to pick colors from')
    parser.add_argument('--o', type=str, required=False,  default='jap.jpg',
                    help='Output file name')
    parser.add_argument('--n', type=int, required=False, 
                    help='Number of Voronoi regions')
    parser.add_argument('--pad', type=float, required=False, 
